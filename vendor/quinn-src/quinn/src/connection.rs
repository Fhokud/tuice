...
impl Connection {
    ...
    /// Derive keying material from the TLS 1.3 early exporter secret.
    ///
    /// Unlike [`Self::export_keying_material`], this can succeed while a
    /// resumed connection is still sending 0-RTT data.
    pub fn export_early_keying_material(
        ...
        self.0
            .state
            .lock("export_early_keying_material")
            .inner
            .crypto_session()
            .export_early_keying_material(output, label, context)
    }
